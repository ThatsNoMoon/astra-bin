...
import extCodeLens from "ace-builds/src-noconflict/ext-code_lens";
ace.config.setModuleUrl("ace/ext/code_lens", extCodeLens);
import extCommand_bar from "ace-builds/src-noconflict/ext-command_bar";
ace.config.setModuleUrl("ace/ext/command_bar", extCommand_bar);
import extElasticTabstopsLite from "ace-builds/src-noconflict/ext-elastic_tabstops_lite";
ace.config.setModuleUrl("ace/ext/elastic_tabstops_lite", extElasticTabstopsLite);
import extEmmet from "ace-builds/src-noconflict/ext-emmet";
...
import extHardwrap from "ace-builds/src-noconflict/ext-hardwrap";
...
import extKeybindingMenu from "ace-builds/src-noconflict/ext-keybinding_menu";
ace.config.setModuleUrl("ace/ext/keybinding_menu", extKeybindingMenu);
import extLanguageTools from "ace-builds/src-noconflict/ext-language_tools";
ace.config.setModuleUrl("ace/ext/language_tools", extLanguageTools);
import extLinking from "ace-builds/src-noconflict/ext-linking";
ace.config.setModuleUrl("ace/ext/linking", extLinking);
import extModelist from "ace-builds/src-noconflict/ext-modelist";
ace.config.setModuleUrl("ace/ext/modelist", extModelist);
import extOptions from "ace-builds/src-noconflict/ext-options";
ace.config.setModuleUrl("ace/ext/options", extOptions);
import extPrompt from "ace-builds/src-noconflict/ext-prompt";
ace.config.setModuleUrl("ace/ext/prompt", extPrompt);
import extRtl from "ace-builds/src-noconflict/ext-rtl";
ace.config.setModuleUrl("ace/ext/rtl", extRtl);
import extSearchbox from "ace-builds/src-noconflict/ext-searchbox";
ace.config.setModuleUrl("ace/ext/searchbox", extSearchbox);
import extSettingsMenu from "ace-builds/src-noconflict/ext-settings_menu";
ace.config.setModuleUrl("ace/ext/settings_menu", extSettingsMenu);
import extSpellcheck from "ace-builds/src-noconflict/ext-spellcheck";
ace.config.setModuleUrl("ace/ext/spellcheck", extSpellcheck);
import extSplit from "ace-builds/src-noconflict/ext-split";
ace.config.setModuleUrl("ace/ext/split", extSplit);
import extStaticHighlight from "ace-builds/src-noconflict/ext-static_highlight";
ace.config.setModuleUrl("ace/ext/static_highlight", extStaticHighlight);
import extStatusbar from "ace-builds/src-noconflict/ext-statusbar";
ace.config.setModuleUrl("ace/ext/statusbar", extStatusbar);
import extTextarea from "ace-builds/src-noconflict/ext-textarea";
ace.config.setModuleUrl("ace/ext/textarea", extTextarea);
import extThemelist from "ace-builds/src-noconflict/ext-themelist";
ace.config.setModuleUrl("ace/ext/themelist", extThemelist);
import extWhitespace from "ace-builds/src-noconflict/ext-whitespace";
ace.config.setModuleUrl("ace/ext/whitespace", extWhitespace);

import emacs from "ace-builds/src-noconflict/keybinding-emacs";
ace.config.setModuleUrl("ace/keybinding/emacs", emacs);
import sublime from "ace-builds/src-noconflict/keybinding-sublime";
...
import vscode from "ace-builds/src-noconflict/keybinding-vscode";
